...
import PageError from '../05-pages/error'
...
let data = {
  ...
  "404":{
    ...
    "text": {
      "lv":"<p>Lapa, kuru meklējat, šeit neatrodas. Bat mums ir daudz citu jauku un interesantu lapu, kuras Jūs varat apskatīt :)</p>",
      "en":"<p>The page you are looking for is not here. But we have many other interesting pages that you can look at :)</p>"
    }
  }
}
...
export default class Layout extends Component {
  constructor(props) {
    ...
    this.state = {
      lang: this.props.lang ? this.props.lang : Cookies.get('language')
    }
  ...
  render() {
    ...
    return (
      <div className="site__layout-wrap">
        <HeaderMain lang={lang} data={data.pages}/>
        <main id="main">
          <Switch>
